...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-sm text-center text-sm font-medium uppercase tracking-[0.12em] transition-all duration-300 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        // CTA principal doré
