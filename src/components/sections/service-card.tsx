  ...
  return (
    <Reveal delay={index * 0.08}>
      <Link
        href={href}
        className={cn(
          "group relative flex h-full flex-col justify-between overflow-hidden rounded-lg border p-7 transition-all duration-300",
          featured
            ? "border-or/40 bg-gradient-to-br from-or/10 to-transparent hover:border-or"
            : "border-or/15 bg-noir-soft hover:border-or/40 hover:bg-noir-elevated",
        )}
      >
        {/* Halo doré au survol */}
        <span
