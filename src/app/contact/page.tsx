      ...
      <section className="py-20 sm:py-24">
        <Container>
          <div className="grid gap-12 lg:grid-cols-[1fr_0.8fr] lg:gap-16">
            {/* Formulaire */}
            <Reveal>
              <div className="rounded-2xl border border-or/15 bg-noir-soft/50 p-6 sm:p-8">
            ...
            <Reveal delay={0.1}>
              <div className="space-y-8">
                ...
                <ul className="space-y-4">
                  <li>
                    <a
                      ...
                      className="group flex items-center gap-4 rounded-lg border border-or/15 bg-noir-soft p-4 transition-colors hover:border-or/40"
                    >
                ...
                <div className="flex items-start gap-3 rounded-lg border border-or/15 bg-gradient-to-br from-or/10 to-transparent p-5">
