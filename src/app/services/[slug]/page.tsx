    ...
    <>
      ...
      <section className="py-20 sm:py-24">
        <Container>
              ...
              <Reveal key={mod.title}>
                <article
                  className={
                    ...
                    (mod.signature
                      ? " rounded-2xl border border-or/40 bg-gradient-to-br from-or/10 to-transparent p-6 sm:p-10"
                      : "")
                  }
                >
          ...
          {/* Réassurance */}
          <Reveal>
            <div className="mt-16 flex items-start gap-4 rounded-lg border border-or/15 bg-noir-soft p-6">
